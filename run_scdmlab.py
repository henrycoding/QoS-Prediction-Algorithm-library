...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', '-d', type=str, default='WSDream_general', help='name of datasets')
    ...
    run_scdmlab(model=args.model, dataset=args.dataset, dataset_type=args.dataset_type,
